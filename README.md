...
Это локальный пайплайн: Markdown → RAG → чат с LLM. Эта система позволяет обработать несколько файлов и получать ответы от локальной языковой модели исключительно на основе индексированных ею данных.
...
Инструкции по запуску, выключению системы и использованию - в файле **HOW_TO_USE.md**.