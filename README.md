...
Это локальный пайплайн: OCR → Markdown → RAG → чат с LLM. Эта система позволяет обработать несколько файлов и получать ответы от локальной языковой модели исключительно на основе индексированных ею данных.
...
Установка и первичная настройка всех компонентов системы - в файле **INSTALL.md**.